...
void StartSetting::onEnterTransitionDidFinish()
{
    ...
    //playMusic("sound/FightMapBGM.mp3","sound/ClickSound.mp3",true,0);
    //SimpleAudioEngine::getInstance()->playBackgroundMusic("SafeMapBGM.mp3", true);
}
...
void StartSetting::cleanup()
{
    Scene::cleanup();
    log("Setting cleanup");
    playMusic("sound/FightMapBGM.mp3", "sound/ClickSound.mp3", true, 1);
...
void StartSetting::menuMusicToggleCallback(Ref* pSender)
{
    ...
    playMusic("sound/FightMapBGM.mp3", "sound/ClickSound.mp3", true, musicToggleMenuItem->getSelectedIndex());
    ...
    {
        SimpleAudioEngine::getInstance()->playBackgroundMusic("SafeMapBGM.mp3");
    }
    if (isEffect)
    {
        SimpleAudioEngine::getInstance()->playEffect("ClickSound.mp3");
