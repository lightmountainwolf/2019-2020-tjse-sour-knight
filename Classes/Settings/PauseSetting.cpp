...
bool PauseSetting::init()
{
	...
	auto menuSoundIncrease = MenuItemImage::create(
		...
		"Buttons/buttonVolumnIncreaseClicked.png", CC_CALLBACK_1(PauseSetting::menuSoundVolumnIncrease, this));
	menuSoundIncrease->setAnchorPoint(Vec2(0, 0));
	menuSoundIncrease->setPosition(Vec2(58, 290));

	auto menuSoundDecrease = MenuItemImage::create(
		"Buttons/buttonVolumnDecrease.png",
		"Buttons/buttonVolumnDecreaseClicked.png", CC_CALLBACK_1(PauseSetting::menuSoundVolumnDecrease, this));
	menuSoundDecrease->setAnchorPoint(Vec2(0, 0));
	menuSoundDecrease->setPosition(Vec2(58, 170));
	...
	auto menuMusicIncrease = MenuItemImage::create(
		"Buttons/buttonVolumnIncrease.png",
		"Buttons/buttonVolumnIncreaseClicked.png", CC_CALLBACK_1(PauseSetting::menuMusicVolumnIncrease, this));
	menuMusicIncrease->setAnchorPoint(Vec2(0, 0));
	menuMusicIncrease->setPosition(Vec2(217, 290));

	auto menuMusicDecrease = MenuItemImage::create(
		"Buttons/buttonVolumnDecrease.png",
		"Buttons/buttonVolumnDecreaseClicked.png", CC_CALLBACK_1(PauseSetting::menuMusicVolumnDecrease, this));
	menuMusicDecrease->setAnchorPoint(Vec2(0, 0));
	menuMusicDecrease->setPosition(Vec2(217, 170));


	Menu* menu = Menu::create(setting, continueButton, home, soundToggleMenuItem, musicToggleMenuItem,
...
void PauseSetting::menuMusicVolumnIncrease(Ref* pSender)
{
	MusicVolumnIncrease();
	playSound("sound/ClickSound.mp3");
}

void PauseSetting::menuMusicVolumnDecrease(Ref* pSender)
{
	MusicVolumnDecrease();
	playSound("sound/ClickSound.mp3");
}

void PauseSetting::menuSoundVolumnIncrease(Ref* pSender)
{
	SoundVolumnIncrease();
	playSound("sound/ClickSound.mp3");
}

void PauseSetting::menuSoundVolumnDecrease(Ref* pSender)
{
	SoundVolumnDecrease();
	playSound("sound/ClickSound.mp3");
}